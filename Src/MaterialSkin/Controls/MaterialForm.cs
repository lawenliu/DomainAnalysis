...
namespace MaterialSkin.Controls
{
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            iconbuttonBounds = new Rectangle(SkinManager.FORM_PADDING / 2, 0, STATUS_BAR_BUTTON_WIDTH, STATUS_BAR_HEIGHT);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            bool showMin = MinimizeBox && ControlBox;
            bool showMax = MaximizeBox && ControlBox;
            bool showIcon = ShowIcon && ControlBox;
            ...
            if (showIcon)
            {
                g.DrawIcon(
                    Icon, 
                    new Rectangle(iconbuttonBounds.X + (int)(iconbuttonBounds.Width * 0.2), iconbuttonBounds.Y + (int)(iconbuttonBounds.Height * 0.2), (int)(iconbuttonBounds.Width * 0.6), (int)(iconbuttonBounds.Height * 0.6)));
            }

            //Form title
            g.DrawString(Text, SkinManager.ROBOTO_MEDIUM_12, SkinManager.ColorScheme.TextBrush, new Rectangle(iconbuttonBounds.Width + SkinManager.FORM_PADDING, 0, Width, ACTION_BAR_HEIGHT), new StringFormat { LineAlignment = StringAlignment.Center });
