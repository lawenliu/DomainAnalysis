...
for (score <- scores) {
  //scala.tools.nsc.io.File("C:\\Users\\xlian\\Documents\\TFSDomainAnalysis\\CareTeam\\DomainAnalysis\\DomainAnalysis\\External\\TmtTool\\tmtOutputInfo.txt", true).writeAll("[perplexity] perplexity at "+score.numTopics+" topics: "+score.perplexity+"\n");  
}
